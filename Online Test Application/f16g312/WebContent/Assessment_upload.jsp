...
<h:panelGrid columns="2">
<h:outputLabel value="Select Assessment" />
   
    <h:selectOneMenu value="#{actionBeanFile.examId}" converter="javax.faces.Integer">
    <f:selectItem itemValue="1" itemLabel="Exam1" />
     <f:selectItem itemValue="2" itemLabel="Exam2" />
      <f:selectItem itemValue="3" itemLabel="Exam3"/>
	</h:selectOneMenu>
